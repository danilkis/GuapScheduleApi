...
class Query:
        ...
        def schedule_get(group, week) -> str:
            return (
                "SELECT groups.group_number, week_type.week_name, "
                "(week_days.week_number, week_days.week_name), "
                "time.pair_number, time.start_time, time.end_time, "
                "lesson.lesson_name, teachers.name, classroom.classroom_name "
                "FROM groups "
                ...
                "ORDER BY schedule.week_days_id, schedule.pair_number_id;")
